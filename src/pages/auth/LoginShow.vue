...
<style scoped>
.login-page{min-height:100vh;padding:24px;display:flex;flex-direction:column}.brand{font-size:21px;font-weight:800}.login-page section{margin:auto 0;text-align:center}.symbol{font-size:88px;margin-bottom:24px}.login-page h1{font-size:32px;line-height:1.3}.login-page section p{margin-top:16px;color:var(--team-color-gray-600)}.login-actions{display:grid;justify-items:center;gap:8px}.kakao{width:300px;height:45px;padding:0;border:0;border-radius:6px;background:none;overflow:hidden;cursor:pointer}.kakao img{display:block;width:300px;height:45px}.kakao:focus-visible{outline:2px solid #191919;outline-offset:3px}.login-actions p{text-align:center;color:var(--team-color-danger);font-size:12px}
</style>
